...
- (IBAction)loginTapped:(id)sender {
    ...
    [[FIRAuth auth] signInWithEmail:eMailEntered
                         ...
                         completion:^(FIRUser *user, NSError *error) {
                             ...
                             if(![self validateEmailWithString:eMailEntered] && [passwordEntered length] == 0 && [eMailEntered length] !=0) {
                             ...
                             else if([eMailEntered length] == 0 && [passwordEntered length] !=0) {
                                 
                                 UIAlertController *ac = [UIAlertController alertControllerWithTitle:@"GuestVite" message:[NSString stringWithFormat:@"%@\n\n%@",@"Email address is empty, please enter the email address",@"Please check your password and try again"]preferredStyle:UIAlertControllerStyleAlert];
                                 ...
                                 UIAlertController *ac = [UIAlertController alertControllerWithTitle:@"GuestVite" message:[NSString stringWithFormat:@"%@\n\n%@",@"Email address is empty, please enter the email address",@"Password Field is empty, please enter your password"]preferredStyle:UIAlertControllerStyleAlert];
                                 ...
                                 UIAlertController *ac = [UIAlertController alertControllerWithTitle:@"GuestVite" message:[NSString stringWithFormat:@"%@",@"Email address is empty, please enter the email address"]preferredStyle:UIAlertControllerStyleAlert];
                             ...
                             else if(![self validateEmailWithString:eMailEntered] && [passwordEntered length] <= 6 && [eMailEntered length] !=0) {
                             ...
                             else if(![self validateEmailWithString:eMailEntered] && [eMailEntered length] !=0) {
